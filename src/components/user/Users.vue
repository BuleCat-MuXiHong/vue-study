<template>
  <div>
    ...
    <!--  添加用户对话框  -->
    <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="50%" @close="addDialogVisibleClosed">
      <!--   内容主体区   -->
    ...
    <el-dialog title="修改用户" :visible.sync="edItDialogVisible" width="50%">
      <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="100px" @close="edItDialogClose">
...
export default {
  ...
  methods: {
    ...
    async setRole(userInfo) {
      ...
      if (res.meta.status != 200) {
        this.$message.error("获取所有的角色列表失败")
      }
